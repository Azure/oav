...
export class Deployments {
   ...
   * @param options The options parameters.
   */
  async validateAtScope(
    scope: string,
    deploymentName: string,
    parameters: Deployment,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsValidateAtScopeResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      scope,
      deploymentName,
      parameters,
    ...
    return new LROPoller({
      initialOperationArguments: operationArguments,
      initialOperationSpec: validateAtScopeOperationSpec,
      initialOperationResult,
      sendOperation
    });
  }
   ...
   * @param options The options parameters.
   */
  async validateAtTenantScope(
    deploymentName: string,
    parameters: ScopedDeployment,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsValidateAtTenantScopeResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      deploymentName,
      parameters,
      options: this.getOperationOptions(options, "undefined")
    ...
    return new LROPoller({
      initialOperationArguments: operationArguments,
      initialOperationSpec: validateAtTenantScopeOperationSpec,
      initialOperationResult,
      sendOperation
    });
  }
   ...
   * @param options The options parameters.
   */
  async whatIfAtTenantScope(
    deploymentName: string,
    parameters: ScopedDeploymentWhatIf,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsWhatIfAtTenantScopeResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      deploymentName,
      parameters,
    ...
    return new LROPoller({
      initialOperationArguments: operationArguments,
      initialOperationSpec: whatIfAtTenantScopeOperationSpec,
      initialOperationResult,
      sendOperation,
   ...
   * @param options The options parameters.
   */
  async validateAtManagementGroupScope(
    groupId: string,
    deploymentName: string,
    parameters: ScopedDeployment,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsValidateAtManagementGroupScopeResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      groupId,
      deploymentName,
      parameters,
    ...
    return new LROPoller({
      initialOperationArguments: operationArguments,
      initialOperationSpec: validateAtManagementGroupScopeOperationSpec,
      initialOperationResult,
      sendOperation
    });
  }
   ...
   * @param options The options parameters.
   */
  async whatIfAtManagementGroupScope(
    groupId: string,
    deploymentName: string,
    parameters: ScopedDeploymentWhatIf,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsWhatIfAtManagementGroupScopeResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      groupId,
      deploymentName,
      parameters,
    ...
    return new LROPoller({
      initialOperationArguments: operationArguments,
      initialOperationSpec: whatIfAtManagementGroupScopeOperationSpec,
      initialOperationResult,
      sendOperation,
      finalStateVia: "location"
    });
   ...
   * @param options The options parameters.
   */
  async validateAtSubscriptionScope(
    deploymentName: string,
    parameters: Deployment,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsValidateAtSubscriptionScopeResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      deploymentName,
      parameters,
      options: this.getOperationOptions(options, "undefined")
    ...
    return new LROPoller({
      initialOperationArguments: operationArguments,
      initialOperationSpec: validateAtSubscriptionScopeOperationSpec,
      initialOperationResult,
      sendOperation
    });
  }
  ...
  async validate(
    ...
    parameters: Deployment,
    options?: coreHttp.OperationOptions
  ): Promise<LROPoller<DeploymentsValidateResponse>> {
    const operationArguments: coreHttp.OperationArguments = {
      resourceGroupName,
      deploymentName,
      parameters,
...
const whatIfAtTenantScopeOperationSpec: coreHttp.OperationSpec = {
...
const whatIfAtManagementGroupScopeOperationSpec: coreHttp.OperationSpec = {
  path:
