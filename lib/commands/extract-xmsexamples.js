...
exports.builder = {
  d: {
    ...
    'then the output will be stored in a same folder adjacent to the directory of the swagger spec.',
    strting: true
  }
};
...
exports.handler = function (argv) {
  ...
  return validate.generateXMsExamples(specPath, recordings, vOptions);
}
