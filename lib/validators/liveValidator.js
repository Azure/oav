...
class LiveValidator {
  ...
  initialize() {
    ...
    if (self.options.swaggerPaths.length !== 0) {
      ...
      let allJsons = path.join(self.options.directory, '/specification/**/*.json');
      swaggerPaths = _(glob.sync(allJsons, { ignore: ['**/examples/**/*', '**/quickstart-templates/**/*', '**/schema/**/*', '**/live/**/*', '**/wire-format/**/*'] }));
