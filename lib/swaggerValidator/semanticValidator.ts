...
import swaggerSchemaDoc from "@autorest/schemas/swagger-extensions.json" with { type: "json" };
import swaggerExampleSchemaDoc from "@autorest/schemas/example-schema.json" with { type: "json" };
...
import swagger2SchemaDoc from "./swagger-2.0.json" with { type: "json" };
