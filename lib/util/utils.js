...
exports.relaxEntityType = function relaxEntityType(entity, isRequired) {
  if (exports.isPureObject(entity) && entity.type) {
    delete entity.type;
  }
  if (entity.additionalProperties && exports.isPureObject(entity.additionalProperties) && entity.additionalProperties.type) {
...
exports.allowNullableParams = function allowNullableParams(parameter) {
  if (parameter["in"] && parameter["in"] === "body" && parameter["schema"]) {
    ...
    if (parameter["in"] && parameter["in"] !== "path" && parameter.in !== "query") {
