...
describe("markdownReport", () => {
    it("Should generate markdown report", () => {
      const ts = {
        ...
        "stepResult": [
          {
            "exampleFilePath": "Microsoft.Compute/preview/2020-09-30/test-scenarios/examples/CreateOrUpdateASimpleGalleryWithSharingProfile.json",
            "operationId": "Galleries_CreateOrUpdate",
            "runtimeError": [
              {
                "code": "RUNTIME_ERROR_400",
                "message": "code: BadRequest, message: Subscription 'db5eb68e-73e2-4fa8-b18a-46cd1be4cce5' is not registered with the feature Microsoft.Compute/SIGSharing. Please register the subscription before retrying the call.",
                "severity": "Error",
          ...
          {
            "exampleFilePath": "Microsoft.Compute/preview/2020-09-30/test-scenarios/examples/DeleteAGallery.json",
